...
public final class FabricUtilityGameRules {
    ...
    public static GameRules.Key<GameRules.BooleanRule> ADMIN_NICKNAME_CHANGE_LOGS;
    ...
    public static void register() {
        ...
        ADMIN_NICKNAME_CHANGE_LOGS = GameRuleRegistry.register("fabricUtilityAdminNicknameChangesAffectHistory", GameRules.Category.PLAYER, GameRuleFactory.createBooleanRule(true));
    }
}
